...
class PostCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create post_category" do
    assert_difference('PostCategory.count') do
      post :create, post_category: { description: @post_category.description, icon: @post_category.icon, name: @post_category.name }
    end
  ...
  test "should update post_category" do
    patch :update, id: @post_category, post_category: { description: @post_category.description, icon: @post_category.icon, name: @post_category.name }
    assert_redirected_to post_category_path(assigns(:post_category))
  end
