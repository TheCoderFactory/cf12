...
class FeedbackFormsControllerTest < ActionController::TestCase
  ...
  test "should create feedback_form" do
    assert_difference('FeedbackForm.count') do
      post :create, feedback_form: { achieve: @feedback_form.achieve, another: @feedback_form.another, best_part: @feedback_form.best_part, comments: @feedback_form.comments, course_id: @feedback_form.course_id, location_id: @feedback_form.location_id, recommend: @feedback_form.recommend, satisfaction: @feedback_form.satisfaction, value: @feedback_form.value }
    end
  ...
  test "should update feedback_form" do
    patch :update, id: @feedback_form, feedback_form: { achieve: @feedback_form.achieve, another: @feedback_form.another, best_part: @feedback_form.best_part, comments: @feedback_form.comments, course_id: @feedback_form.course_id, location_id: @feedback_form.location_id, recommend: @feedback_form.recommend, satisfaction: @feedback_form.satisfaction, value: @feedback_form.value }
    assert_redirected_to feedback_form_path(assigns(:feedback_form))
  end
