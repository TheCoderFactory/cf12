...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { content: @testimonial.content, gender: @testimonial.gender, image: @testimonial.image, name: @testimonial.name, one_line: @testimonial.one_line, product_id: @testimonial.product_id, publish: @testimonial.publish }
    end
  ...
  test "should update testimonial" do
    patch :update, id: @testimonial, testimonial: { content: @testimonial.content, gender: @testimonial.gender, image: @testimonial.image, name: @testimonial.name, one_line: @testimonial.one_line, product_id: @testimonial.product_id, publish: @testimonial.publish }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
