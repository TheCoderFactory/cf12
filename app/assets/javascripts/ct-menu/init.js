    ...
    $(document).ready(function () {
        ...
        if($($headroomCla).length > 0){
            $($headroomCla).each(function(){
                ...
                var $startPositionNavbar = validatedata($this.attr("data-startposition"), 40);
                ...
                if($fixedBoth || $fixedTopBar || $fixedMenu || $fixedScrollUpTopBarConfirmed){
                    ...
                    var ctpinned = validatedata($this.attr("data-pinned"), "headroom--pinned"); //effect when elements appears itself -  when scrolling up
                    var ctunpinned = validatedata($this.attr("data-unpinned"), "headroom--unpinned"); //effect when elements disappears itself -  when scrolling down
                }
